...
export default function Nav() {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-12 bg-cream border-b border-warm transition-shadow duration-300 ${
          scrolled ? 'shadow-[0_2px_24px_rgba(26,23,20,0.08)]' : ''
        }`}
        style={{ height: '72px' }}
      >
      ...
      {/* Mobile dropdown */}
      {menuOpen && (
        <div className="fixed top-[72px] left-0 right-0 z-40 bg-cream border-b border-warm shadow-lg md:hidden">
